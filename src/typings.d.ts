...
declare namespace TetherShepherd {
    ...
    export interface IShepherdTourOptions {
        steps?: IShepherdTourStep[];
        defaults?: IShepherdTourStepOptions;
    }

    export interface IShepherdTour {
    ...
    export interface IShepherdTourStep {
        /**
         * Show this step
         */
        show(): void;
    ...
    export interface IShepherdTourStepOptions {
        text?: any;
        title?: string;
        attachTo?: any;
    ...
    export interface IShepherdTourButton {
        text: string;
        classes?: string;
        action?: Function;
    ...
    export interface IShepherdTourButtonEventHash {
        [Key: string]: Function;
    }

    export interface IShepherdTourAttachProperties {
        element: string;
        on: string;
    }
}
